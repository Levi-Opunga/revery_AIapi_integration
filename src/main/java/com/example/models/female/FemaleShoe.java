...
package com.example.models.female;
...
public class FemaleShoe implements Serializable {
     ...
     * @param shoeModelIds
     */
    public FemaleShoe(List<String> shoeModelIds, ShoePathsDict shoePathsDict, Boolean success) {
        super();
